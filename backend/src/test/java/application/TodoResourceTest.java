...
public class TodoResourceTest {
    ...
    public void testGetTodos() {
        ...
        expected.add(new FullTodoDTO(1, "Bla", "Do the bla", true, LocalDateTime.of(2020, Month.JANUARY, 10, 7, 30)
                .toString()));
        expected.add(new FullTodoDTO(2, "Blubb", "Do the blubb", false, LocalDateTime
                .of(2020, Month.FEBRUARY, 20, 10, 00).toString()));
    ...
    public void testGetTodoById() {
        Mockito.doReturn(new Todo(1, "Bla", "Do the bla", true, LocalDateTime.of(2020, Month.JANUARY, 10, 7, 30)))
                .when(service)
                .getTodoById(1);
        FullTodoDTO expected = new FullTodoDTO(1, "Bla", "Do the bla", true, LocalDateTime
                .of(2020, Month.JANUARY, 10, 7, 30).toString());
